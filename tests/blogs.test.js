...
describe('when logged in', async() => {
    ...
    test('When logged in, blog form works', async() => {
        const text = await page.getContentsOf('form label');
        expect(text).toEqual('Blog Title');
    });

    describe('Using proper inputs', async() => {
        beforeEach(async() => {
        ...
        test('Submitting & saving adds blog', async() => {
    ...
    describe('And using invalid inputs', async() => {
        ...
        test('the form shows proper error msg', async() => {
